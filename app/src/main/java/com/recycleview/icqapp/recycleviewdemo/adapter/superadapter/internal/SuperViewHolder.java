package com.recycleview.icqapp.recycleviewdemo.adapter.superadapter.internal;
...
public class SuperViewHolder extends RecyclerView.ViewHolder implements ChainSetter<SuperViewHolder> {
    ...
    @Override
    public SuperViewHolder setAdapter(int viewId, RecyclerView.LayoutManager layoutManager, RecyclerView.Adapter adapter) {
        RecyclerView view = getView(viewId);
